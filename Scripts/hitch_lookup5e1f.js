$(function () {
    ...
    $('#select_mount').live('change', function () {
        ...
        if (mount != "") {
            ...
            $.get('https://api.curtmfg.com/V2/GetYear?dataType=JSONP&callback=loadYear', { 'mount': mount }, 'jsonp');
        }
    });
    ...
    $('#select_year').live('change', function () {
        ...
        if (year > 0) {
            ...
            $.get('https://api.curtmfg.com/V2/GetMake?dataType=JSONP&callback=loadMake', { 'mount': mount, 'year': year }, 'jsonp');
        }
    });
    ...
    $('#select_make').live('change', function () {
        ...
        if (year > 0) {
            ...
            $.get('https://api.curtmfg.com/V2/GetModel?dataType=JSONP&callback=loadModel', { 'mount': mount, 'year': year, 'make': make }, 'jsonp');
        }
    });
    ...
    $('#select_model').live('change', function () {
        ...
        if (year > 0) {
            ...
            $.get('https://api.curtmfg.com/V2/GetStyle?dataType=JSONP&callback=loadStyle', { 'mount': mount, 'year': year, 'make': make, 'model': model }, 'jsonp');
        }
    });
